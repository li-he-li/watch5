param(
    [string]$DeviceSerial,
    [string]$ApkPath = "phone-app/build/outputs/apk/debug/phone-app-debug.apk"
)
...
Invoke-Adb shell am start -n com.heartrate.phone/.MainActivity

Write-Host "==> Phone app deployed and launched."
